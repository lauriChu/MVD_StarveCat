...
void Game::init() {
	...
	//with Alberto you will create something more robust, this is just a temporary thing
	...
	//while the 'p' key switches to the fps camera/control. Which currently does exactly the same!
